    ...
    <body>
        <div style="height:92px; width:962px; margin:auto; position:relative">
            ...
            <div class="toolsContainer">
                <!--
                <a href="<?php
                //echo Yii::app()->controller->createUrl(Yii::app()->controller->action->id, array_intersect_key($_GET, array_flip(array('id'))));
                ?>" title="English Version"><span>ENGLISH</span></a>&nbsp;|&nbsp;
                <a href="<?php
                   // echo Yii::app()->controller->createUrl(Yii::app()->controller->action->id, array_intersect_key($_GET, array_flip(array('id')))) . '?language=zh_tw';
                ?>" title="中文版"><span>中文</span></a><br/><br/>-->
                <?php $this->widget('ext.LangPick.ELangPick', array()); ?>
                <span style="line-height: 23px;">
                    <a href="https://www.facebook.com/RoyalCaribbeanHongKong" target="_blank"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/header/icon_facebook.png" alt="" title=""/></a>&nbsp;|&nbsp;<a href="/tc/contact.php" title="CONTACT U">聯絡我們</a>
                </span>
            </div>
        ...
        <div style='<?php echo (!empty($thispage) && $thispage == "enquiry") ? "height:66px" : "height:102px" ?>; width:962px; position: relative; margin:auto; background: #fff url(<?php echo Yii::app()->request->baseUrl; ?>/images/header/bg_breadcrumb.png) left bottom repeat-x' >
            ...
            <div class='mainMenu' style="z-index:999999;">
                <ul>
                    <li><a href="<?php Yii::app()->royalCaribbeanHelper->echoBooking_menu_link('index.php'); ?>" title="Royal Caribbean International" >首頁</a></li>
                    <li>
                        <a>航線行程</a>
                        <ul>
                    ...
                    <li>
                        <a>遊輪體驗</a>
                        <ul>
                            <li><a href="<?php Yii::app()->royalCaribbeanHelper->echoBooking_menu_link('tc/dreams.php'); ?>">WOW頻道</a></li>
                            <li><a href="<?php Yii::app()->royalCaribbeanHelper->echoBooking_menu_link('tc/cabin.php'); ?>">豪華客房</a></li>
                            <li><a href="<?php Yii::app()->royalCaribbeanHelper->echoBooking_menu_link('tc/food.php'); ?>">環宇美食</a></li>
                            <li><a href="<?php Yii::app()->royalCaribbeanHelper->echoBooking_menu_link('tc/entertainment.php'); ?>">娛樂活動</a></li>
            ...
            <div style="width: 920px; position: absolute; color: #444; line-height: 35px; left: 8px; top: 71px;"><a href="index.php">首頁</a> &gt; <a href="#">預約</a>
            </div>
        </div>
                                ...
                                <li id="footer_menu_01">
                                    <b>航線行程
                                        <ul class="sub_menu" id="footer_sub_menu_01">
                                            <li><a style="position: relative;" href="<?php Yii::app()->royalCaribbeanHelper->echoBooking_menu_link('tc/result.php'); ?>">航線行程</a></li>
                                            <li><a style="position: relative;" href="<?php Yii::app()->royalCaribbeanHelper->echoBooking_menu_link('tc/shoreExcursions.php'); ?>">岸上觀光</a></li>
                                            <li><a style="position: relative;" href="<?php Yii::app()->royalCaribbeanHelper->echoBooking_menu_link('tc/departure-port-hong-kong.php'); ?>">亞洲出發</a></li>
                                            <li><a style="position: relative;" href="<?php Yii::app()->royalCaribbeanHelper->echoBooking_menu_link('tc/top-10-destinations.php'); ?>">全球十大航綫</a></li>
                                        </ul>
                                    </b>
                                </li>
                                ...
                                <li id="footer_menu_02">
                                    <b>皇家船隊
                                        <ul class="sub_menu" id="footer_sub_menu_02">
                                            <li><a style="position: relative;" href="<?php Yii::app()->royalCaribbeanHelper->echoBooking_menu_link('tc/voyager.php'); ?>">海洋航行者號</a></li>
                                            <li><a style="position: relative;" href="<?php Yii::app()->royalCaribbeanHelper->echoBooking_menu_link('tc/quantum.php'); ?>">海洋量子號</a></li>
                                            <li><a style="position: relative;" href="<?php Yii::app()->royalCaribbeanHelper->echoBooking_menu_link('tc/royal-fleet.php'); ?>">皇家全球船隊</a></li>
                                        </ul>
                                    </b>
                                </li>

                                <li id="footer_menu_03">
                                    <b>皇家禮遇<ul class="sub_menu" id="footer_sub_menu_03">
                                            <li><a style="position: relative;" href="<?php Yii::app()->royalCaribbeanHelper->echoBooking_menu_link('tc/royal-deals.php'); ?>">皇家禮遇</a></li>
                                        </ul>
                                    </b>
                                </li>

                                <li id="footer_menu_04"><b>遊輪體驗
                                        <ul class="sub_menu" id="footer_sub_menu_04">
                                            <li><a style="position: relative;" href="<?php Yii::app()->royalCaribbeanHelper->echoBooking_menu_link('tc/dreams.php'); ?>">WOW頻道</a></li>
                                            <li><a style="position: relative;" href="<?php Yii::app()->royalCaribbeanHelper->echoBooking_menu_link('tc/cabin.php'); ?>">豪華套房</a></li>
                                            <li><a style="position: relative;" href="<?php Yii::app()->royalCaribbeanHelper->echoBooking_menu_link('tc/food.php'); ?>">環宇美食</a></li>
                                            <li><a style="position: relative;" href="<?php Yii::app()->royalCaribbeanHelper->echoBooking_menu_link('tc/entertainment.php'); ?>">娛樂活動</a></li>
                                            <li><a style="position: relative;" href="<?php Yii::app()->royalCaribbeanHelper->echoBooking_menu_link('tc/sports.php'); ?>">船上運動</a></li>
                                            <li><a style="position: relative;" href="<?php Yii::app()->royalCaribbeanHelper->echoBooking_menu_link('tc/parentChild.php'); ?>">親子樂園</a></li>
                                            <li><a style="position: relative;" href="<?php Yii::app()->royalCaribbeanHelper->echoBooking_menu_link('tc/mice.php'); ?>">商旅公務</a></li>
                                            <li><a style="position: relative;" href="<?php Yii::app()->royalCaribbeanHelper->echoBooking_menu_link('tc/passion.php'); ?>">海上浪漫</a></li>
                                        </ul>
                                    </b>
                                </li>
                                ...
                                <li id="footer_menu_05">
                                    <b>行前須知
                                        <ul class="sub_menu" id="footer_sub_menu_05">
                                            <li><a style="position: relative;" href="<?php Yii::app()->royalCaribbeanHelper->echoBooking_menu_link('tc/notice.php'); ?>">行前須知</a></li>
                                            <li><a style="position: relative;" href="<?php Yii::app()->royalCaribbeanHelper->echoBooking_menu_link('tc/qa.php'); ?>">常見問題</a></li>
                                            <li><a style="position: relative;" href="<?php Yii::app()->royalCaribbeanHelper->echoBooking_menu_link('tc/departure-port-hong-kong.php'); ?>">出發港【香港】</a></li>
                                        </ul>
                                    </b>
                                ...
                                <li id="footer_menu_06">
                                    <b>皇冠金錨俱樂部
                                        <ul class="sub_menu" id="footer_sub_menu_06">
                                            <li><a style="position: relative;" href="<?php Yii::app()->royalCaribbeanHelper->echoBooking_menu_link('tc/crown-and-anchor-society-about.php'); ?>">關於俱樂部</a></li>
                                            <li><a style="position: relative;" href="<?php Yii::app()->royalCaribbeanHelper->echoBooking_menu_link('tc/crown-and-anchor-society-benefits.php'); ?>">會員權益</a></li>
                                        </ul>
                                    </b>
                                </li>
                            </ul>
                        ...
                        <div style="float: left; width: 100%;">
                            ...
                            <div style="float: left; height: 58px; margin: 24px 0 0 0;">
                                <b><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/header/rccl-crest.png">
                                    <span style="line-height: 28px;font-weight: normal;font-family: arial;color: #000000;margin-left: 7px;">本網站資料均為皇家加勒比國際遊輪有限公司版權所有</span></b>
                            </div>

                            <div style="float: right; height: 58px; margin: 16px 15px 0 0;font-weight: normal;font-family: arial;color: #3d94cb;">
                                <b>
                                    <a href="privacypolicy.php" style="color: #3d94cb;font-weight: normal;line-height: 45px;">私隱條例聲明 </a>&nbsp;&nbsp;|&nbsp;&nbsp;
                                    <a href="copyrights.php" style="color: #3d94cb;font-weight: normal;">版權政策</a>
