...
<div style="width: 920px; position: absolute; color: #444; line-height: 35px; left: 8px; top: 71px;"><a href="index.php">Home</a> &gt; Plan A Cruise &gt; <a href="rccl_xjp.php">Hong Kong Homeport</a>
</div>
</div>
...
<p>Located in the heart of Victoria Harbour (at the south-eastern end of the former Kai Tak Airport runway), the terminal is easy to find and offers panoramic
</p>
...
<table width="95%" border="0" align="left" cellpadding="3" cellspacing="0">
	...
	<tr>
		...
		<td style="padding-left:10px;" align="left" valign="top">KMB bus route 5R provides a Saturday, Sunday and holiday service between the cruise terminal, Ngau Tau Kok and Kwun Tong MTR station from 11am-7pm with a fare charged at $6.7. The headway of the bus route service will be approximately 30 minutes. Click here for more details.</td>
	</tr>
	<tr>
