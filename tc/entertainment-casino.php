...
<li class="page_hover">皇家賭場<sup>&reg;</sup></li>
<li><a href="entertainment-duty-free.php">免稅店</a></li>
<li><a href="entertainment-spa.php">水療中心</a></li>
</ul>

<div style="position:relative; float:left; width:640px; left:30px;top:-7px;min-height:600px;">
<style>
.food_01{margin:0px;}
...
<table width="95%" border="0" cellspacing="0" cellpadding="5">
  ...
  <tr>
    <td align="left" valign="top"><div class="food-text1">
      <div class="brdefydq">皇家賭場<sup>&reg;</sup></div>
      擁有300多個賭場耍樂。無論你是一個高手或門外漢，都可以在這裡度過樂趣無窮的時光。
</div></td>
    </tr>
  </table>
