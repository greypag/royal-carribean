...
<div id="slider2_container" style=" float:left; position:relative; margin-top:0px; width: 962px; height: 365px;">
  ...
  <div u="slides" style="cursor: move; position: absolute; overflow: hidden; left: 0px; top: 0px; width: 962px; height: 365px;">
    <div>
      <img u="image"  src="../newimages/wine-dine/slideshow/slide_show_01.jpg"  />
      <img u="thumb"  src="../newimages/wine-dine/slideshow/thumbnail_01.gif"  />
    </div>
    <div>
      <img u="image"  src="../newimages/wine-dine/slideshow/slide_show_02.jpg"  />
      <img u="thumb"  src="../newimages/wine-dine/slideshow/thumbnail_02.gif"  />
    </div>
    <div>
      <img u="image"  src="../newimages/wine-dine/slideshow/slide_show_03.jpg"  />
      <img u="thumb"  src="../newimages/wine-dine/slideshow/thumbnail_03.gif"  />
    </div>
    <div>
      <img u="image"  src="../newimages/wine-dine/slideshow/slide_show_04.jpg"  />
      <img u="thumb"  src="../newimages/wine-dine/slideshow/thumbnail_04.gif"  />
    </div>
  </div>
