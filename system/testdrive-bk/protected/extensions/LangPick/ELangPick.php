...
class ELangPick extends CPortlet {
    ...
    protected function renderContent() {
        ...
        $translations = array_reverse(array_diff($translations, $this->excludeFromList));

        //CVarDumper::dump( $translations , 10, true);
        
        echo '<div id="languagePickerContainer" style="margin-bottom: 14px;">';
