...
<div class="float" style="margin-top: 10px;color: #666666">
    ...
    <input type="checkbox" name="PICS" class="" required> We shall keep your personal data confidential at all times. All personal data collected will be in accordance with the Personal Data (Privacy) Ordinance under the law of Hong Kong.
    </span>
</div>
<br>
