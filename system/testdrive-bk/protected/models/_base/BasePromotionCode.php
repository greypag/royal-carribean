...
abstract class BasePromotionCode extends GxActiveRecord {
    ...
    public function rules() {
        return array(
            ...
            array('figure_per_guest, quota, accumulate_quota, create_date, update_date', 'numerical', 'integerOnly' => true, 'min' => 0),
            array('promotion_id', 'length', 'max' => 128),
			array('promotion_name, promotion_name_tc', 'length', 'max' => 512),
            array('promotion_code, type', 'length', 'max' => 32),
            ...
            array('promotion_id, promotion_name, promotion_name_tc, promotion_code, start_date, end_date, type, figure_per_guest, quota, accumulate_quota, internal_notes, non_pricing_notes,itinerary_id', 'safe', 'on' => 'search'),
        );
    }
