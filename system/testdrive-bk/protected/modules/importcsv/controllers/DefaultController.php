...
class DefaultController extends Controller {
                                        ...
                                        if ($filecontent[$i] != '') {
                                            ...
                                            if ($mode == 1) {
                                                ...
                                                if ($insertCounter == $perRequest || $i == $lengthFile - 1) {
                                                    $import = $model->InsertAll($table, $insertArray, $columns, $tableColumns); //Sai: Calling  ImportCsv.php
                                                    $insertCounter = 0;
                                                    $insertArray = array();
    ...
    public function checkOldFile($uploadfile) {
        ...
        if (file_exists($selectfileNew)) {
            ...
            $paramsArray['delimiter'] = ",";  //Sai
            $paramsArray['textDelimiter'] = '';  //Sai
            $paramsArray['table'] = "";
            $paramsArray['mode'] = "";
