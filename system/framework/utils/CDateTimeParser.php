...
class CDateTimeParser {
    ...
    public static function parse($value, $pattern = 'MM/dd/yyyy', $defaults = array()) {
        ...
        /*
          CVarDumper::dump($value . '<br/>');
          CVarDumper::dump($pattern . '<br/>');
          CVarDumper::dump($year . '<br/>');
          CVarDumper::dump($month . '<br/>');
          CVarDumper::dump($day . '<br/>');
          CVarDumper::dump(CTimestamp::isValidDate($year, $month, $day));

          CVarDumper::dump($hour.'<br/>');
          CVarDumper::dump($minute.'<br/>');
          CVarDumper::dump($second.'<br/>');
         */
