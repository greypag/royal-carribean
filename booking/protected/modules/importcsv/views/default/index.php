...
<div id="importCsvSteps">
    ...
    <div id="importCsvSecondStep">
        ...
        <?php
        //echo CHtml::textField("delimiter", $delimiter, array('readonly'=>true));  //Sai seted it read only  
        echo CHtml::textField("delimiter", $delimiter);
        ?>
        <br/><br/>

        <strong><?php echo Yii::t('importcsvModule.importcsv', 'Text Delimiter'); ?></strong><br/>
        <?php
        //echo CHtml::textField("textDelimiter", $textDelimiter, array('readonly' => true)); //Sai seted it read only 
        echo CHtml::textField("textDelimiter", $textDelimiter);
        ?>
        <br/><br/>
