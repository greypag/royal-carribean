...
$(document).ready(function() {
	$.ajax({url: "storeExcursions/vietnam-s0.html?nocache="+Math.random(), success: function(result){
		$("#content").html(result);
	}});		
    ...
    $("#cat li").click(function() {
		...
		$("#"+this.id+"-s").addClass("active");
		$.ajax({url: "storeExcursions/"+this.id+"-s0.html?nocache="+Math.random(), success: function(result){
			$("#content").html(result);
		}});		
    });
