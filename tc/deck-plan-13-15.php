...
<div style="position:relative; float:left; width:640px; left:30px;min-height:550px;"><br />
  ...
  <div style="float: left; width: 300px;">
    ...
    <div style="line-height: 20px;">
      ...
      <br>
      <span class="bold">第15層甲板</span><br>
      <br>
      天光教堂
      <br><br><br>
      <span class="bold">第14層甲板</span><br>
      <br>
      IZUMI日式餐廳<br><br>
      專屬鑽石會<br><br>
      維京皇冠酒廊
      <br>
      <br><br>
      <span class="bold">第13層甲板</span><br>
      <br>
      攀岩墙<br><br>
      籃球場<br><br>
      9洞迷你高爾夫推桿練習場 <br><br>
  ...
  <div style="float: left;">
    <img height="1266" width="260" id="deckimg" name="deckimg" src="../newimages/deck-plan/deck-plan/tc/Deck-13.jpg">
    <br><br><br><br>
  </div>
