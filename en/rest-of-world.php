...
<div style="width: 920px; position: absolute; color: #444; line-height: 35px; left: 8px; top: 71px;"><a href="index.php">Home</a> &gt; <a href="get-royal-deals.php">Rest of World</a>
</div>
</div>
...
<h3 style="float:left">Rest of World</h3>
<a href="enquiry.php">
...
<li class="wider-190"><a href="get-royal-deals.php">Selected Sailingg</a></li>
<li class="page_hover-190">International Sailing</li>
...
<?php   }  ?>
        <div class="getRoyalDealsAgentGrid left">
          ...
          <div class="getRoyalDealsAgentHotline">Hotline: <?php echo $royaldeals_data["agents"][$i]["hotline"]?></div>
          <div class="getRoyalDealsAgentLicense">License number: <?php echo $royaldeals_data["agents"][$i]["license"]?></div>
        </div>
