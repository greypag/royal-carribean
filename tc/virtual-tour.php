...
<ul class="wider">
<li class="wider"><a href="voyager.php">海洋航行者號</a></li>
<li class="wider"><a href="onboard-experience.php">船上特色</a></li>
<li class="page_hover_wider" style="display:none;">360&deg;展示</li>
</ul>

<div style="position:relative; float:left; width:640px; left:30px;min-height:500px;">

<object width="640" height="400">
    <param name="movie" value="../newimages/VT_Flash_Voyager.swf">
    <embed src="../newimages/VT_Flash_Voyager.swf" width="640" height="400">
    </embed>
</object>
