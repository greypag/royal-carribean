...
<html>
    <head>
        ...
        <script src="<?php echo Yii::app()->request->baseUrl; ?>/assets/select/dist/js/select2.min.js"></script>
    ...
    <body>
        ...
        <div style="height:92px; width:962px; margin:auto; position:relative">
            ...
            <div style="display: block; width: 600px; height: 75px; position: absolute; margin-top:15px; margin-left:-4px; z-index:50;">
                <a href="index.php" title="Royal Caribbean International"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/icons/logo.png"/></a></div>
            ...
            <div class="toolsContainer">
                ...
                <span style="line-height: 23px;">
                    <a href="https://www.facebook.com/RoyalCaribbeanHongKong" target="_blank"><img src="<?php echo Yii::app()->request->baseUrl; ?>/images/header/icon_facebook.png" alt="" title=""/></a>&nbsp;|&nbsp;<a href="contact.php" title="CONTACT U">Contact Us</a>
                </span>
            </div>
        ...
        <div style='<?php echo (!empty($thispage) && $thispage == "enquiry") ? "height:66px" : "height:102px" ?>; width:962px; position: relative; margin:auto; background: #fff url(<?php echo Yii::app()->request->baseUrl; ?>/images/header/bg_breadcrumb.png) left bottom repeat-x' >
            ...
            <div style="width: 920px; position: absolute; color: #444; line-height: 35px; left: 8px; top: 71px;"><a href="index.php">Home</a> &gt; <a href="#">Booking</a>
            </div>
        </div>
                            ...
                            <span>
                                ...
                                Booking Hotline：<b>
                                    <div style="width:650px;font-size:16px; line-height:200%; color:#ffde00;">
                                        <strong>+852 3189 3200</strong> | <a href="mailto:enquiry@royalcaribbean-hongkong.com" style="color:#ffde00; text-decoration:none; font-weight:normal;">enquiry@royalcaribbean-hongkong.com</a>
                            ...
                            <ul style="width: 890px;margin: 0 auto;overflow: hidden;">
                                <li id="footer_menu_01">
                                    <b>Plan A Cruise
                                        <ul class="sub_menu" id="footer_sub_menu_01">
                                            <li><a style="position: relative;" href="result.php">Plan A Cruise</a></li>
                                            <li><a style="position: relative;" href="shoreExcursions.php">Shore Excursions</a></li>
                                            <li><a style="position: relative;" href="departure-port-hong-kong.php">Asia Ports of Departure</a></li>
                                            <li><a style="position: relative;" href="top-10-destinations.php">Top 10 Destinations</a></li>
                                        </ul>
                                    </b>
                                </li>
                                ...
                                <li id="footer_menu_02">
                                    <b>Find a Ship
                                        <ul class="sub_menu" id="footer_sub_menu_02">
                                            <li><a style="position: relative;" href="voyager.php">Voyager of the Seas</a></li>
                                            <li><a style="position: relative;" href="quantum.php">Quantum of the Seas</a></li>
                                            <li><a style="position: relative;" href="royal-fleet.php">Royal Fleet</a></li>
                                        </ul>
                                    </b>
                                </li>
                                ...
                                <li id="footer_menu_03">
                                    <b>Get Royal Deals<ul class="sub_menu" id="footer_sub_menu_03">
                                            <li><a style="position: relative;" href="royal-deals.php">Get Royal Deals</a></li>
                                        </ul>
                                    </b>
                                </li>
                                ...
                                <li id="footer_menu_04"><b>All About Cruising
                                        <ul class="sub_menu" id="footer_sub_menu_04">
                                            <li><a style="position: relative;" href="dreams.php">WOW Channel</a></li>
                                            <li><a style="position: relative;" href="cabin.php">Staterooms</a></li>
                                            <li><a style="position: relative;" href="food.php">Wine &amp; Dine</a></li>
                                            <li><a style="position: relative;" href="entertainment.php">Entertainment</a></li>
                                            <li><a style="position: relative;" href="sports.php">Sports</a></li>
                                            <li><a style="position: relative;" href="parentChild.php">Family</a></li>
                                            <li><a style="position: relative;" href="mice.php">MICE</a></li>
                                            <li><a style="position: relative;" href="passion.php">Passion</a></li>
                                        </ul>
                                    </b>
                                </li>
                                ...
                                <li id="footer_menu_05">
                                    <b>Before You Board
                                        <ul class="sub_menu" id="footer_sub_menu_05">
                                            <li><a style="position: relative;" href="notice.php">Before You Board</a></li>
                                            <li><a style="position: relative;" href="qa.php">FAQ</a></li>
                                            <li><a style="position: relative;" href="departure-port-hong-kong.php">Hong Kong Port of Departure</a></li>
                                        </ul>
                                    </b>
                                ...
                                <li id="footer_menu_06">
                                    <b>Crown &amp; Anchor Society
                                        <ul class="sub_menu" id="footer_sub_menu_06">
                                            <li><a style="position: relative;" href="crown-and-anchor-society-about.php">About the Program</a></li>
                                            <li><a style="position: relative;" href="crown-and-anchor-society-benefits.php">Member Benefits</a></li>
                                        </ul>
                                    </b>
                                </li>
                            </ul>
                    ...
                    <div id="footer_wrap" style="height: 80px; color: #888; width: 980px; margin: auto; line-height: 15px;padding-top: 5px; padding-left: 5px;">
                        <div style="float: left; width: 100%;">
                            ...
                            <div style="float: right; height: 58px; margin: 16px 15px 0 0;font-weight: normal;font-family: arial;color: #3d94cb;">
                                <b>
                                    <a href="privacypolicy.php" style="color: #3d94cb;font-weight: normal;line-height: 45px;">Privacy Policy</a>&nbsp;&nbsp;|&nbsp;&nbsp;
                                    <a href="copyrights.php" style="color: #3d94cb;font-weight: normal;">Copyrights</a>
