...
//    $print('<span>旅行社預訂</span><u><a href="travelAgency.php">查找旅行社</a></u></div>');
    $print('<div class="copyright04" style="width:650px;">');
    $print('<i>');
    $print('<img src="../newimages/r_12.png" width="16" height="18" /></i><span>預訂諮詢熱線：<b><div style="width:650px;font-size:16px; line-height:200%; color:#ffde00;">+852 3189 3200 / <a href="mailto:enquiry@royalcaribbean-hongkong.com" style="color:#ffde00; text-decoration:none;">enquiry@royalcaribbean-hongkong.com</a></div></span></div>');
		...
		$print('<ul>');
			...
			$print('<li id="footer_menu_01">Plan A Cruise');
				$print('<ul class="sub_menu" id="footer_sub_menu_01">');
					...
					$print('<li><a style="position: relative;" href="rccl_xjp.php">Asia Ports of Departure</a></li>');
					//$print('<li><a style="position: relative;" href="overseas.php">十大航线</a></li>');
					$print('<li><a style="position: relative;" href="travelAgency.php">Travel Agency</a></li>');
				$print('</ul>');
			$print('</li>');	
			...
			$print('<li id="footer_menu_03">All About Cruising');
				$print('<ul class="sub_menu" id="footer_sub_menu_03">');
					...
					$print('<li><a style="position: relative;" href="food-1.php">Wine & Dine</a></li>');
			...
			$print('<li id="footer_menu_04">Before You Board');
				$print('<ul class="sub_menu" id="footer_sub_menu_04">');
					...
					$print('<li><a style="position: relative;" href="rccl_xjp.php">Hong Kong Port of Departure</a></li>');
				$print('</ul>');
			$print('</li>');   
	   
			$print('<li id="footer_menu_05">Crown & Anchor Society');
				$print('<ul class="sub_menu" id="footer_sub_menu_05">');
					$print('<li><a style="position: relative;" href="memclub.php">About CAS</a></li>');
					$print('<li><a style="position: relative;" href="member.php">Become A Member</a></li>');
				$print('</ul>');
			$print('</li>');
    ...
    $print('</div>');
	*/
		$print('<div style="height: 80px; color: #888; width: 980px; margin: auto; line-height: 15px;padding-top: 5px; padding-left: 65px;">');
		$print('<div style="float: left; width: 600px;">');
	$print('<div style="float: left; width: 181px; height: 58px; margin: 5px 59px 0 0"><img src="../newimages/img_bottom_logo.png"/></div>');
    $print('</div>');
    $print('</div>');
    $print('</div>');
    $print('</div>');
