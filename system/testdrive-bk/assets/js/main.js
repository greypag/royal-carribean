            ...
            if (i <= 2) {
                ...
                if (promotionCode !== null) {
                    if (promotionCode[1] === 'all' || promotionCode[1] === 'onetwo' && i <= 2 || promotionCode[1] === 'two' && i == 2) {
                        ...
                        sum += _this.operators[promotionCode[0]](f1_withoutNcff, promotionObj.figure_per_guest);
                ...
                if (promotionCode !== null) {
                    if (promotionCode[1] === 'all' || promotionCode[1] === 'threefour') {
                        ...
                        sum += _this.operators[promotionCode[0]](f2_withoutNcff, promotionObj.figure_per_guest);
                        //}
                    }
                }
            }
