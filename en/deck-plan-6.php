...
<div style="position:relative; float:left; width:640px; left:30px;min-height:550px;"><br />
  ...
  <div style="float: left; width: 300px;">
    ...
    <div style="line-height: 20px;">
      ...
      <br>(264 sq. ft., balcony 75 sq. ft.) <br>
      <br>
      <span class="bold">Balcony</span>
      <br>
      <br>
      <span id="icon-d1">&nbsp;D1&nbsp;</span>&nbsp; <span id="icon-d3">&nbsp;D3&nbsp;</span>&nbsp;<a class="icon-bar" href="../newimages/deck-plan/Stateroom_with_Balcony.jpg" id="stateroom_balcony_1" rel="shadowbox;height=400;width=480;bgcolor=#FFF;"><u> Superior Ocean View Stateroom with Balcony</u></a>
      <br>
      ...
      <br>
      <br>
      <span class="bold">Next CruiseSM</span>
      <br>
      Join our complimentary Crown & Anchor® Society loyalty program, and enjoy savings on your next Royal Caribbean vacation. While onboard, meet with our Loyalty & Cruise Sales staff to reserve your next cruise, and you can enjoy
      <br>
      <br>
      <br>
      <div style="line-height: 20px;">
  ...
  <div style="float: left;">
    <img height="1266" width="260" id="deckimg" name="deckimg" src="../newimages/deck-plan/deck-plan/en/Deck-6.gif">
  </div>
