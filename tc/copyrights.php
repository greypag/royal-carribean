...
<div style="width: 920px; position: absolute; color: #444; line-height: 35px; left: 8px; top: 71px;"><a href="index.php">首頁</a> &gt; <a href="copyrights.php">版權政策</a>
</div>
</div>
...
<div class="page_contentbox" style='width:962px'>
	<div style="width: 962px; float: left; position: relative; background: #fff;min-height:600px;">
		<div id="crown-right">
			<div class="title crown-large-title" class="left">版權政策</div>
