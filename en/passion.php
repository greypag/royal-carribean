...
<div style="width: 920px; position: absolute; color: #444; line-height: 35px; left: 8px; top: 71px;"><a href="index.php">Home</a> &gt; All About Cruising &gt; <a href="passion.php">Passion</a></div>
</div>
...
<div id="slider2_container" style=" float:left; position:relative; margin-top:0px; width: 962px; height: 365px;">
  ...
  <div u="slides" style="cursor: move; position: absolute; overflow: hidden; left: 0px; top: 0px; width: 962px; height: 365px;">
    <div>
      <img u="image"  src="../newimages/passion/slideshow/slide_show_01.jpg"  />
      <img u="thumb"  src="../newimages/passion/slideshow/thumbnail_01.gif"  />
    </div>
    <div>
      <img u="image"  src="../newimages/passion/slideshow/slide_show_02.jpg"  />
      <img u="thumb"  src="../newimages/passion/slideshow/thumbnail_02.gif"  />
    </div>
    <div>
      <img u="image"  src="../newimages/passion/slideshow/slide_show_03.jpg"  />
      <img u="thumb"  src="../newimages/passion/slideshow/thumbnail_03.gif"  />
    </div>
    <div>
      <img u="image"  src="../newimages/passion/slideshow/slide_show_04.jpg"  />
      <img u="thumb"  src="../newimages/passion/slideshow/thumbnail_04.gif"  />
    </div>
  </div>
...
<div style="position:relative; float:left; width:640px; left:30px;min-height:800px;top:10px;">

<p>There's never been a better time to get away with that special someone on a Royal Caribbean International® cruise. Rejuvenate with a couples massage in our VitalitySM Spa, reach new heights on our rock-wall, savor a quiet dinner together or relax by the pool and simply do nothing at all. Rekindle the romance and enjoy some quality time together while making memories to last a lifetime. </p>
<div class="sub-head">Skylight Chapel</div>
<p><img src="../newimages/passion/church.jpg" class="display"/> Our wedding chapel, which can accommodate 40 people, is located at the highest point on the ship, and is the perfect place to say I do.</p>

<div class="sub-head">Candlelight Dinner</div>
<p><img src="../newimages/passion/dine.jpg" class="display"/><br />
Formal night in the dining room makes any special occasion even more special. </p>
